...
<<<<<<< HEAD
png("Plots/Unsigned/Kerrigan/Bing.png", width = 600,height = 300)
plot(
  bingInput, 
  type="l", 
  main="Kerrigan Bing Analysis", 
=======
...
<<<<<<< HEAD
png("Plots/Simple/Kerrigan/bing.png", width = 800,height = 500)
simple_plot(bingInput, title = "Kerrigan Bing Plot")
=======
